...
* Introduction
  ...
  =elline.el= is a fast, lightweight, modular mode-line for Emacs. It delivers the same aesthetics of doom-modeline while being much smaller.
...
** Separators appear misaligned
   ...
   - Try adjusting =elline-separator-raise= (try -0.08 to -0.15 for Iosevka Nerd Font).
